				...
				try{			
					...
					if (request.getMethod().equalsIgnoreCase("post")) {
						...
						if (s_name == null || s_name.equals("")	&& (s_quality == null || s_quality.equals("") || s_quality.equals("None")) && (s_ATKrange == null || s_ATKrange.equals("")) && (s_HP == null || s_HP.equals("")) && (s_MP == null || s_MP.equals("")) && (s_ATK == null || s_ATK.equals("")) && (s_DEF == null || s_DEF.equals(""))	&& (s_ALG == null || s_ALG.equals(""))){
							...
							sql = "INSERT INTO t_mount VALUES ('";

							r.next();
							int c = Integer.valueOf(r.getString(1));

							if (c+1 > 100) {
								sql += "M" + String.valueOf(c+1) + "', '" ;
							} else if (c+1 > 10) {
								sql += "M0" + String.valueOf(c+1) + "', '" ;
							} else {
								sql += "M00" + String.valueOf(c+1) + "', '" ;
							} 	
						...
						<form method="post" action="">
							<table class="edit bg">
								<tr> 
									...
									<td class="lable">
										<span class="blue">坐騎名稱</span>
										<br>
										<span class="gold">坐騎品質</span>
									</td>
									<td class="input">
									...
									<table class="edit bg">
										<tr> 
											...
											<td colspan="2" class="edit">
												<input type="submit" name="modify" value="修改" formaction="mount_modify.jsp"></input>
											</td> 
											<td colspan="2" class="edit">
												<input type="submit" name="delete" value="刪除" formaction="mount_delete.jsp"></input>
											</td> 
										</tr>
										<tr>
											<td class="green lable">
